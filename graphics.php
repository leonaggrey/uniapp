    ...
    <main>
        ...
        <section id="chats">
            ...
            <div id="messages">
				...
				<?php
					...
					if(isset($_POST['submit'])) {
						include("graphics_chats.php");
					}else{
						include("graphics_retrieve.php");
					}?>
			...
			<div id="popup">
				...
				<form id="poptext" name="concernform" method="post" action="graphics.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
			...
			<div >
            <form method="post" id="text" action="graphics.php" enctype="multipart/form-data">
