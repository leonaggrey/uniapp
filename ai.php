    ...
    <main>
        ...
        <section id="chats">
            ...
            <div id="messages">
				...
				<?php
					...
					if(isset($_POST['submit'])) {
						include("ai_chats.php");
					}else{
						include("ai_retrieve.php");
					}?>
			...
			<div id="popup">
				...
				<form id="poptext" name="concernform" method="post" action="ai.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
			...
			<div >
            <form method="post" id="text" action="ai.php" enctype="multipart/form-data">
