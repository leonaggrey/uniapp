    ...
    <main>
        ...
        <section id="chats">
            ...
            <div id="messages">
				...
				<?php
					...
					if(isset($_POST['submit'])) {
						include("simulation_chats.php");
					}else{
						include("simulation_retrieve.php");
					}?>
			...
			<div id="popup">
				...
				<form id="poptext" name="concernform" method="post" action="simulation.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
			...
			<div >
            <form method="post" id="text" action="simulation.php" enctype="multipart/form-data">
