    ...
    <main>
        ...
        <section id="chats">
			...
			<div id="popup">
				...
				<div ><a href="commercial.php" class="chat_link">
					<div class="chat_icon">
						<ion-icon name="happy-outline" id="user"></ion-icon>
					</div>
					<div class="chat_header">
						<h2>Commercial Programming</h2>
					</div></a>
				</div>
				<div ><a href="simulation.php" class="chat_link">
					<div class="chat_icon">
						<ion-icon name="happy-outline" id="user"></ion-icon>
					</div>
					<div class="chat_header">
				...
				<div ><a href="ai.php" class="chat_link">
					<div class="chat_icon">
						<ion-icon name="happy-outline" id="user"></ion-icon>
					</div>
					<div class="chat_header">
				...
				<div ><a href="discrete.php" class="chat_link">
					<div class="chat_icon">
						<ion-icon name="happy-outline" id="user"></ion-icon>
					</div>
					<div class="chat_header">
						<h2>Discrete Structures II</h2>
					</div></a>
				</div>
				<div ><a href="networks.php" class="chat_link">
					<div class="chat_icon">
						<ion-icon name="happy-outline" id="user"></ion-icon>
					</div>
					<div class="chat_header">
				...
				<div ><a href="graphics.php" class="chat_link">
					<div class="chat_icon">
						<ion-icon name="happy-outline" id="user"></ion-icon>
					</div>
					<div class="chat_header">
