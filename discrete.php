    ...
    <main>
        ...
        <section id="chats">
            ...
            <div id="messages">
				...
				<?php
					...
					if(isset($_POST['submit'])) {
						include("discrete_chats.php");
					}else{
						include("discrete_retrieve.php");
					}?>
			...
			<div id="popup">
				...
				<form id="poptext" name="concernform" method="post" action="discrete.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
			...
			<div >
            <form method="post" id="text" action="discrete.php" enctype="multipart/form-data">
