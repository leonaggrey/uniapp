    ...
    <main>
        ...
        <section id="chats">
			...
			<div id="popup">
				...
				<form id="poptext" name="concernform" method="post" action="commercial.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
			...
			<div >
            <form method="post" id="text" action="commercial.php" enctype="multipart/form-data">
