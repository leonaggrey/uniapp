    ...
    <main>
        ...
        <section id="chats">
            ...
            <div id="messages">
				...
				<?php
					...
					if(isset($_POST['submit'])) {
						include("networks_chats.php");
					}else{
						include("networks_retrieve.php");
					}?>
			...
			<div id="popup">
				...
				<form id="poptext" name="concernform" method="post" action="networks.php" enctype="multipart/form-data" onsubmit="return validateForm1()">
			...
			<div >
            <form method="post" id="text" action="networks.php" enctype="multipart/form-data">
